...
public class RegisterTest extends BaseClass {
	...
	public void testRegisterPage(String browser) throws InterruptedException, IOException {
		...
		if(regist.unsuccessMsg().isDisplayed()){
			String msg = regist.unsuccessMsg().getText();
			System.out.println("unsuccess message: "+msg);
			Assert.assertTrue(true);
			screenshot();
			ExtentReport.createTest("Register Testcase").log(Status. PASS,"RegisterTest Completed for already existed email ");
		}
	}
	@AfterTest
